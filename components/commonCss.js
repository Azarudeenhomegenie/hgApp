module.exports = {
    ...
    //font-ends
    defaultText: { fontFamily: 'PoppinsM', color: '#525252', fontSize: 14 },
    defaultSubText: { fontFamily: 'PoppinsR', color: '#525252', fontSize: 12 },
    //colors-starts
    brandC: { color: '#2eb0e4' },
    ...
    BGbrand: { backgroundColor: '#2eb0e4' },
    BGliteBlue: { backgroundColor: '#eff7fc' },
    BGyellow: { backgroundColor: '#f6b700' },
    BGliteWhite: { backgroundColor: '#fafafa' },
    BGliteYellow: { backgroundColor: '#fffcf1' },
    BGblack: { backgroundColor: '#525252' },
    BGliteBlack: { backgroundColor: '#7e7e7e' },
    BGliteGrey: { backgroundColor: '#F4F4F4' },
    BGrgrey: { backgroundColor: '#7070701c' },
    BGltGray: { backgroundColor: '#d1d1d150' },
    BGlGrey: { backgroundColor: '#60604E' },
    BGwhite: { backgroundColor: '#fff' },
    BGmaroon: { backgroundColor: '#d36565' },
    BGscreen: { backgroundColor: '#FAFBFF' },
    //bg-ends
    section: {
        fontFamily: 'PoppinsR',
        fontSize: 14,
