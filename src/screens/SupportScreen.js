            ...
            <View style={[styles.bookingTabsContent,], { alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                <View style={{
                    ...
                    <Image
                        ...
                        source={require('@assets/icons/support_smiley.png')}
                    />
                </View>
            ...
            <View style={[css.borderRadius10, css.whiteBG, css.padding10, css.marginT20]}>
                <List.AccordionGroup>
                    <List.Accordion
                        ...
                        right={props => <Image style={{ position: 'absolute', right: -20, top: -35, transform: [{ rotate: "0deg" }] }} source={require('@assets/icons/arrowDown_hg.png')} />}
                    >
                        ...
                        <View style={[css.liteBlueBG, css.borderRadius20, css.padding20]}>
                            <View>
                                ...
                                <View style={[css.flexDR, css.marginT5]}>
                                    <Text >Look for
                                        <Image style={[css.img20]} source={require('@assets/icons/emergency.png')} />
                    ...
                    >
                        <View style={[css.liteBlueBG, css.borderRadius20, css.padding20]}>
                            ...
                            <View style={[css.flexDR, css.marginL10]}>
                                <Text style={[css.fsb,]}>{'\u2022'}{'  '}</Text>
                                <Text style={[css.flexDR, css.blackC, css.fm, css.f14,]}><Image style={[css.img20, { width: 20, height: 20 }]} source={require('@assets/icons/priceverification.png')} /> view the type of service and the applicable pricing details; and</Text>
                            </View>
                            <View style={[css.flexDR, css.marginL10]}>
                                <Text style={[css.fsb,]}>{'\u2022'}{'  '}</Text>
                                <Text style={[css.flexDR, css.blackC, css.fm, css.f14,]}><Image style={[css.img20, { width: 20, height: 20 }]} source={require('@assets/icons/expert.png')} /> This type of service requires the Genie to mandatory visit the customer location to inspect and diagnose the issue and propose a solution and provide an estimate of material and labour required e.g. AC repair service. There is an inspection call-out charge for this service.</Text>
                            </View>
                        </View>
                    </List.Accordion>
