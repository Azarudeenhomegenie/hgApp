                    ...
                    renderItem={({ item }) => (
                        <View style={[css.container, css.liteBlueBG, styles.fixedHeader, css.line, css.paddingB10, css.paddingT10]}>
                            <View style={[css.flexDR]}>
                                <Pressable onPress={() => navigation.goBack()} style={[css.alignSelfC]}><Image style={[css.marginR20]} source={require('@assets/icons/backArrowBlack.png')} /></Pressable>
                                        ...
                                        <View style={[styles.genieAssigned, css.borderGrey1, css.borderRadius10, css.imgFull]}>
                                            <View style={[css.flexDR, styles.genieHeader, css.padding20]}>
                                                ...
                                                <View style={[css.width60]}>
                                                    ...
                                                    <View style={[css.flexDR]}>
                                                        <Image style={[css.img20]} source={require('@assets/icons/star-fill.png')} />
                                            ...
                                            <Pressable style={[styles.genieFooter, css.brandBG, css.alignCenter, css.imgFull, { height: 60, borderBottomRightRadius: 10, borderBottomLeftRadius: 10 }]}>
                                                ...
                                                >
                                                    <Image source={require('@assets/icons/call-white.png')} />
                                                    <Text>CALL NOW</Text>
                                                </Text>
                                            </Pressable>
                                        </View>
                                        ...
                                        <View style={[styles.genieNotAssigned]}>
                                            <View style={[css.imgFull, css.alignCenter, css.liteBlueBG, css.padding10, css.borderRadius10]}>
                                                <View style={[css.flexDR, css.imgFull]}>
                                                    <View style={[css.whiteBG, css.imgg90, css.marginR10, { borderRadius: 50 }]}><Image style={[css.imgg80]} source={require('@assets/icons/homegenie-logo.png')} /></View>
                                    ...
                                    <View>
                                        <List.Accordion title="Booking Summary" id="1"
                                            ...
                                            right={props => <Image style={{ position: 'absolute', right: -20, top: -35, transform: [{ rotate: "0deg" }] }}
                                                source={require('@assets/icons/arrowDown_hg.png')} />}
                                        >
                                            ...
                                            <View>
                                                <View style={[css.flexDRSB]}>
                                                    ...
                                                    <View style={[css.flexDR]}><Image source={require('@assets/icons/service-info.png')} /><Text style={[css.alignSelfC, css.blackC, css.fm]}>{item.charges.unitCharges ? 'Fixed price' : 'Inspection based'} service</Text></View>
                                                </View>
                                                <View style={[css.flexDRSB]}>
                                        ...
                                        >
                                            ...
                                            <View style={[css.spaceT10]}>
                                                <View style={[css.flexDR]}>
                                                    <View><Image style={[css.marginR20]} source={require('@assets/icons/warranty.png')} /></View>
                                                    <View style={[css.flexDC, css.alignSelfC]}>
