                ...
                <View style={[css.section]}>
                    <View style={[css.container]}>
                        <View style={[css.boxShadow, css.padding20, css.whiteBG, css.borderRadius20]}>
                            ...
                            <View><Image style={[css.imgFull, css.marginT20, css.marginB20,]} resizeMode="contain" source={require('@assets/icons/earnGenie.png')} /></View>
                            <View style={[css.alignItemsC, css.marginT20]}>
                                ...
                                <View style={[css.spaceB5, css.flexDRSE, css.width50]}>
                                    <Image source={require('@assets/icons/social-fb.png')} />
                                    <Image source={require('@assets/icons/social-Instagram.png')} />
                                    <Image source={require('@assets/icons/social-twitter.png')} />
                                </View>
                            </View>
                        </View>
                    </View>
