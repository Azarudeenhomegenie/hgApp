                ...
                <View style={[css.section, css.fixedContainer, { zIndex: 999 }]}>
                    <View style={[css.container, css.whiteBG, styles.fixedHeader, css.padding30,]}>
                        <View style={[css.flexDRSB]}>
                            ...
                            <TouchableOpacity style={[css.flexDC, css.alignCenter]} onPress={() => togglepromocodeModal()}><Image style={[css.img30]} source={require('@assets/icons/percenttags.png')} /><Text style={[css.brandC, css.fsb, css.f18]}>Offer</Text></TouchableOpacity>
                        </View>
                    </View>
                </View>
            </ScrollView>
                                    ...
                                    <View style={styles.rbWrapper}>
                                        ...
                                        <View style={[css.flexDC]}>
                                            <View style={[css.flexDR]}>
                                                ...
                                                <Image style={{ width: 20, height: 20, marginLeft: 5 }} source={require('@assets/icons/emergency-icon-pink.png')} />
                                            </View>
                                            <View style={[css.flexDC]}>
                    ...
                    <View style={bookModal.modalViewFull}>
                        ...
                        <View style={[bookModal.modalBody]}>
                            <View style={[css.flexDR, css.line20]}>
                                <Image style={[css.img30, css.marginR10]} source={require('@assets/icons/expert.png')} />
                            ...
                            <View style={[css.line20]}>
                                ...
                                <View style={[css.flexDRSA]}>
                                    <Image style={{ width: 50, height: 56 }} source={require('@assets/icons/emergency-2x.png')} />
                                    <Image style={{ width: 50, height: 57 }} source={require('@assets/icons/sameday-2x.png')} />
                                    <Image style={{ width: 51, height: 56 }} source={require('@assets/icons/friday-2x.png')} />
                                    <Image style={{ width: 53, height: 56 }} source={require('@assets/icons/schedule-2x.png')} />
                                </View>
                            </View>
                        </View>
                    </View>
                ...
                <ScrollView>
                    <View style={bookModal.modalViewFull}>
                        <View style={[bookModal.modalHeader]}>
                            ...
                            >
                                <Image style={[css.transform180]} source={require('@assets/icons/backArrowBlack.png')} />
                            </TouchableOpacity>
                        </View>
                        <View style={[bookModal.modalBody]}>
                            <View style={[css.flexDR, css.line20]}>
                                <Image style={[css.img30, css.marginR10]} source={require('@assets/icons/service-info-big.png')} />
                    ...
                    <View style={bookModal.modalViewFull}>
                        ...
                        <View style={[bookModal.modalBody]}>
                            <View style={[css.flexDR, css.line10]}>
                                <Image style={[css.img30, css.marginR10]} source={require('@assets/icons/priceverification.png')} />
                            ...
                            <View style={[css.line20]}>
                                ...
                                <View style={[css.flexDR]}>
                                    <View style={[width30]}><Image style={{ width: 100, height: 90 }} source={require('@assets/icons/warranty.png')} /></View>
            ...
            >
                <ScrollView>
                    <View style={bookModal.modalViewFull}>
                        ...
                        <View style={[bookModal.modalBody,]}>
                            <View style={[css.flexDR, css.line20]}>
                                <Image style={[css.img30, css.marginR10]} source={require('@assets/icons/help-icon-medium.png')} />
                    ...
                    <View style={css.modalNewView}>
                        <View style={[css.modalNewHeader, { backgroundColor: '#fff' }]}>
                            <TouchableOpacity style={[css.flexDR, css.line10, { marginBottom: 0, }]} onPress={() => toggleratingModal()}>
                                <Image style={[css.alignSelfC, css.marginR20]} source={require('@assets/icons/backArrowBlack.png')} />
                        ...
                        <ScrollView>
                            <View style={[css.modalNewBody, css.imgFull, , { paddingTop: 0 }]}>
                                <View style={[css.flexDR]}>
                                    <Image style={[css.marginR20, css.img50]} source={require('@assets/icons/images/acBooking.png')} />
                                    <Text style={[css.fbo, css.f24, css.blackC, css.alignSelfC,]}>AC Service (Preventive) </Text>
                                </View>
                                <View style={[css.marginT5]}>
                                    <View style={[css.flexDR]}>
                                        <Image style={[css.marginR10, css.alignSelfC]} source={require('@assets/icons/bullet_right.png')} />
                            ...
                            <View style={[css.brandBG, css.padding20,]}>
                                <Image source={require('@assets/icons/live.png')} />
                            ...
                            <View style={[css.modalNewBody, css.imgFull]}>
                                <View style={[css.flexDR]}>
                                    <View style={[css.width30]}><Image style={{ resizeMode: 'contain', }} source={require('@assets/icons/warranty.png')} /></View>
            ...
            >
                <View style={[bookModal.modalViewFull, { height: 'auto', marginTop: 'auto', }]}>
                    ...
                    <View style={[bookModal.modalBody, css.marginB30]}>
                        ...
                        <View style={[css.flexDR]}>
                            <Image style={[css.img30, css.marginR10]} source={require('@assets/icons/images/acBooking.png')} />
                ...
                <View style={[bookModal.modalViewFull, { height: 'auto', marginTop: 'auto', }]}>
                    ...
                    <View style={[bookModal.modalBody, css.marginB30]}>
                        ...
                        <View style={[css.boxShadow, css.liteBlueBG, css.padding10, css.borderRadius10, css.marginT10]}>
                            <View style={[css.flexDRSB]}>
                                <View style={[css.flexDR]}>
                                    <View style={[css.alignSelfC]}><Image style={[css.img30, css.marginR5,]} source={require('@assets/icons/percenttags.png')} /></View>
                                    <View style={[css.flexDC]}>
                ...
                <ScrollView>
                    <View style={bookModal.modalViewFull}>
                        <View style={[bookModal.modalHeader]}>
                            ...
                            >
                                <Image style={[css.transform180, css.alignSelfC]} source={require('@assets/icons/backArrowBlack.png')} />
                                <Text style={[css.fr, css.f16, css, blackC, css.marginL10]}>Back</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={[bookModal.modalBody]}>
                            <View style={[css.flexDR, css.line10]}>
                                <Image style={[css.img30, css.marginR10]} source={require('@assets/icons/percenttags.png')} />
