            ...
            > */}
                <View>
                    ...
                    >
                        ...
                        >
                            <Image resizeMode="contain" style={{ width: windowWidth, height: 200 }} source={require("@assets/icons/home_slider1.jpg")} />
                        </View>
                        <View
                            style={styles.slide}
                            title={
                        ...
                        >
                            <Image resizeMode="contain" style={{ width: windowWidth, height: 200 }} source={require("@assets/icons/home_slider2.jpg")} />
                        </View>
                        <View
                            style={styles.slide}
                            title={
                        ...
                        >
                            <Image resizeMode="contain" style={{ width: windowWidth, height: 200 }} source={require("@assets/icons/home_slider3.jpg")} />
                        </View>
                    </Swiper> */}
                </View>
                {infoBar ? (
                ...
                <View style={styles.screen}>
                    <View style={styles.section}>
                        ...
                        <View style={[css.flexDRSB, css.imgFull]}>
                            ...
                            >
                                <Image source={require('@assets/icons/Handyman.png')} style={[styles.backgroundImage, css.img95,]} />
                        ...
                        <View style={[css.flexDRSB, css.imgFull]}>
                            ...
                            >
                                <Image
                                    source={require("@assets/icons/pet_groom.png")}
                                    style={[styles.backgroundImage, css.img95]}
                                />
                                <View style={styles.overlay} />
