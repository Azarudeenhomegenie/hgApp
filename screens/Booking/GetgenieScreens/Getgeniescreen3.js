...
import css, { flexDR, justifyContentC } from '../commonCss';
import { ProgressSteps, ProgressStep } from 'react-native-progress-steps';
import GetgenieHeader from '../GetgenieScreens/GetgenieHeader';
...
import GetgenieFooter from '../GetgenieScreens/GetgenieFooter';
let imgPath = "../../assets/";
            ...
            <ScrollView>
                <View style={[css.section], { marginTop: 190 }}>
                    <View style={[css.container]}>
                        <View>
                            <Image style={{ width: '100%', height: 150, borderTopLeftRadius: 10, borderTopRightRadius: 10, }} source={require(imgPathImages + 'acCoolingBooking.png')} />
                        ...
                        <View style={{
                            ...
                            <View style={[css.spaceT10]}>
                                    ...
                                    <View>
                                        <View style={[css.flexDRSA]}>
                                            ...
                                            <View style={[css.flexDR]}>
                                                <Pressable onPress={() => setModalComingsoon(true)} style={{ width: 25 }}><Image source={require(imgPath + 'edit.png')} /></Pressable>
                                                <Pressable onPress={() => setModalComingsoon(true)} style={{ width: 25 }}><Image source={require(imgPath + 'delete.png')} /></Pressable>
                                            </View>
                                        </View>
                                    </View>
                                </View>
                                ...
                                <Pressable style={[css.flexDR]}>
                                    <Image style={[css.img20]} source={require(imgPath + 'iconLocationBlue.png')} />
