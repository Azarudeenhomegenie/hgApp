        ...
        <View style={[css.section, styles.fixedContainer]}>
            <View style={[css.container, css.liteBlueBG, styles.fixedHeader]}>
                <View style={[css.flexDRSA]}>
                    <View style={{ width: '10%' }}>
                        <Image style={{ width: 40, height: 40, justifyContent: 'center' }} source={require(imgPathImages + 'acBooking.png')} />
                    </View>
                    ...
                    <View style={{ flexDirection: 'column', padding: 10, justifyContent: 'center', alignItems: 'center' }}>
                        <Image style={{ width: 20, height: 20 }} source={require(imgPath + 'iconLocationBlue.png')} />
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        >
                            <Image style={{ width: 15, height: 15, justifyContent: 'center', alignItems: 'center' }} source={require(imgPath + 'close.png')} />
                        </TouchableOpacity>
                        <Image style={{ width: 20, height: 20, justifyContent: 'center', alignItems: 'center' }} source={require(imgPath + 'login-icon.png')} />
                    </View>
                </View>
