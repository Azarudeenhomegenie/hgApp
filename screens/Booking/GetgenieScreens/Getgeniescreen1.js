...
import css, { blackC, flexDR, marginR10, paddingL10, spaceB30, width30 } from '../commonCss';
                    ...
                    <View style={css.modalNewView}>
                        ...
                        <ScrollView>
                            <View style={[css.modalNewBody, css.imgFull, , { paddingTop: 0 }]}>
                                <View style={[css.flexDR]}>
                                    <Image style={[css.marginR20, css.img50]} source={require(imgPathImages + 'acBooking.png')} />
            ...
            >
                <View style={[bookModal.modalViewFull, { height: 'auto', marginTop: 'auto', }]}>
                    ...
                    <View style={[bookModal.modalBody, css.marginB30]}>
                        ...
                        <View style={[css.flexDR]}>
                            <Image style={[css.img30, css.marginR10]} source={require(imgPathImages + 'acBooking.png')} />
