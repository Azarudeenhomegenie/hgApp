...
const dailyImage = imgPath + 'Handyman2x.png'
const healthImage = imgPath + 'Health2x.png'
const lifeImage = imgPath + 'Lifestyle2x.png'
const otherImage = imgPath + 'Others2x.png'
...
export default function CategoryScreen({ navigation, route }) {
    ...
    const dailyImage = imgPath + 'Handyman2x.png'
    const healthImage = imgPath + 'pcr.png'
    const lifeImage = imgPath + 'Lifestyle2x.png'
    const otherImage = imgPath + 'pet_groom.png'
                            ...
                            />
                                ...
                                />
                                    : catName == 'lifestyledecor' ? <Image
                                        style={([], { width: "100%", height: 250, borderRadius: 20 })}
                                        source={require(lifeImage)}
                                    />
                                        : catName == 'others' ? <Image
                                            style={([], { width: "100%", height: 250, borderRadius: 20 })}
                                            source={require(otherImage)}
                                        />
                                            : <Image
                                                style={([], { width: "100%", height: 250, borderRadius: 20 })}
                                                source={require(otherImage)}
                        ...
                        <View style={[styles.categoryservices, css.flexDRSB, { flexWrap: 'wrap' }]}>
                            ...
                            <TouchableOpacity style={[styles.child, styles.childRemove]} onPress={() => navigation.goBack()}>
                                <Image
                                    ...
                                    source={require(imgPath + 'forwardArrow.png')}
                                />
