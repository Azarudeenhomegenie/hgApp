                            ...
                            <View style={[css.container]}>
                                <View style={[css.boxShadow, css.padding20]}>
                                    <View style={[css.alignCenter]}>
                                        ...
                                        >
                                            {displayProfilePic ? <Image style={{ borderRadius: 50, width: 70, height: 70 }} source={{ uri: displayProfilePic }} />
                                                : <Image style={{ borderRadius: 50, }} source={require(imgPath + 'genieicon.png')} />
                                            }
                                        </Pressable>
                                    ...
                                    <View style={[css.marginB5]}>
                                        ...
                                        />
                                        <Image style={{ position: 'absolute', right: 15, top: 15 }} source={require(imgPath + 'basicInfo_user.png')} />
                                    </View>
                                    <View style={[css.marginB5]}>
                                        <TextInput
                                            style={[form.input,]}
                                        ...
                                        <Image style={{ position: 'absolute', right: 15, top: 15 }} source={require(imgPath + 'basicInfo_calendar.png')} />
                                    </View>
                                    <View style={[css.marginB5]}>
                                        <TextInput
                                            style={[form.input,]}
                                            ...
                                            editable={false}
                                        />
                                        <Image style={{ position: 'absolute', right: 15, top: 15 }} source={require(imgPath + 'basicInfo_mobile.png')} />
                                    </View>
                                    <View style={[css.marginB5]}>
                                        <TextInput
                                            style={[form.input,]}
                                            ...
                                            editable={false}
                                        />
                                        <Image style={{ position: 'absolute', right: 15, top: 15 }} source={require(imgPath + 'basicInfo_mail.png')} />
                                    </View>
                                    <View style={[css.marginB5]}>
                                        <TextInput
                                            style={[form.input,]}
                                        ...
                                        />
                                        <Image style={{ position: 'absolute', right: 15, top: 15 }} source={require(imgPath + 'basicInfo_comment.png')} />
                                    </View>
                                    <View style={[css.marginB5]}>
                                        <TextInput
                                            style={[form.input,]}
                                        ...
                                        />
                                        <Image style={{ position: 'absolute', right: 15, top: 15 }} source={require(imgPath + 'basicInfo_flag.png')} />
                                    </View>
                                </View>
                                <Pressable
