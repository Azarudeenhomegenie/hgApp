            ...
            <View style={css.header}>
                <View style={css.flexDR}>
                    ...
                    <View style={[css.flexDR_ALC]}>
                        <Image style={[styles.titleIcon]} source={require(imgPath + "iconCardWhite.png")} />
                    ...
                    <View style={[css.section]}>
                        <View style={[css.container, { height: windowHeight - 100 }]}>
                            <View style={[css.flexDCSB, css.alignItemsC, { flex: 1 }]}>
                                ...
                                <View style={[css.imgBR150, css.whiteBG, css.alignCenter]}><Image style={[css.img100]} source={require(imgPath + 'iconAddCard.png')} /></View>
